...
function calcularIPAFinal() {
    ...
    const ipaFinal1 = document.querySelector('.ipaFinal');

    if (ipaFinal1.textContent != null){
        ipaFinal1.textContent = ipaFinal;
    }
...
function calcularPorcentagemIPAFinal() {
    ...
    if (ipaFinal === 1 && todosVazios) {
        ...
        const ppFinal1 = document.querySelector('.ppFinal');

        if (ppFinal1.textContent != null){
            ppFinal1.textContent = porcentagemIPAFinal;
        }
